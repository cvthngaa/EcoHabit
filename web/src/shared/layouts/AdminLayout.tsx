...
const navigation = [
  ...
  { name: 'Hồ sơ doanh nghiệp', to: '/profile', icon: Store },
  { name: 'Điểm thu gom', to: '/locations', icon: MapPin },
  { name: 'Lịch sử thu gom', to: '/transactions', icon: ListOrdered },
  { name: 'Quà tặng & Voucher', to: '/rewards', icon: Gift },
];
