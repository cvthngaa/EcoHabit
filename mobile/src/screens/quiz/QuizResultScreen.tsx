    ...
    return (
        <View className="flex-1 bg-brand">
            ...
            <View className="flex-1 px-6">
                ...
                {/* Top Podium Section */}
                <View className="bg-[#155A03] rounded-[32px] p-8 items-center mb-6 ">
                    ...
                    <View className="items-center">
                        {profile?.avatarUrl ? (
                            <Image
                                ...
                                className="w-24 h-24 rounded-full border-4 border-white mb-[-12px] z-10 "
                            />
                        ) : (
                            <View className="w-24 h-24 rounded-full bg-[#FFE95C] items-center justify-center border-4 border-white mb-[-12px] z-10">
                                <Text className="text-5xl">{isPerfect ? '👑' : isGood ? '🌟' : '💪'}</Text>
                            </View>
                        )}

                        <View className="bg-white rounded-full px-5 py-2 flex-row items-center gap-2 ">
                ...
                {/* Bottom List Section */}
                <View className="bg-white rounded-[32px] p-6 flex-1 mb-8 ">
