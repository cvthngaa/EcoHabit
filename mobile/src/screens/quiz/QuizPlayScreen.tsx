...
const QuizPlayScreen: React.FC = () => {
 ...
 <SharedHeaderBackground forceGradient={true}>
 {/* Header */}
 <View
 ...
 <Text className="font-bold text-lg text-[#3A3A3A]">{topicName}</Text>
 ...
 {/* Question Card */}
 <View className="bg-white rounded-[32px] p-8 mb-8 min-h-[160px] justify-center items-center">
 ...
 >
 <View className={`w-10 h-10 rounded-xl items-center justify-center mr-4 ${letterBoxClass} `}>
