...
const LanguageSettingsScreen: React.FC<any> = ({ navigation }) => {
 ...
 await updateSettings({ language: localLanguage });
 showToast('Đã áp dụng lựa chọn ngôn ngữ.', 'success');
 };
