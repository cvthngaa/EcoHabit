...
// The wave path used to clip mist and to cover tree trunks
const WAVE_PATH = "M0 126C0 126 53.6009 100.096 90 101.5C121.904 102.731 136.135 123.986 168 126C223.517 129.509 245.515 71.0278 301 75C318.303 76.2387 327.484 87.3743 344.5 84C361.34 80.6607 364.043 56.8186 381 59.5C389.899 60.9072 401 63.5 401 63.5V-50H0V126Z";
...
const HeroForeground: React.FC<{ fillColor: string }> = ({ fillColor }) => (
 <Svg
 width={width}
 height={HEADER_HEIGHT}
 viewBox="0 -50 401 177"
 ...
 >
 <Defs>
 {/* Clip region = exact wave shape so mist/trees can't spill below */}
 <ClipPath id="waveClip">
   <Path d={WAVE_PATH} />
 </ClipPath>
 </Defs>

 {/* Everything below is clipped to the wave shape */}
 ...
 {/* Mist covering Layer 1 – clipped to wave */}
 <Rect x="0" y="-50" width="100%" height="250" fill="#FFFFFF" opacity={0.45} clipPath="url(#waveClip)" />
 ...
 {/* Mist covering Layer 2 – clipped to wave */}
 <Rect x="0" y="-50" width="100%" height="250" fill="#FFFFFF" opacity={0.25} clipPath="url(#waveClip)" />
...
const HeroHeader: React.FC<HeroHeaderProps> = ({
 ...
 const waveFillColor = appearance === 'nature' ? '#E3EFE1' : '#FFFFFF';
 ...
 <HeroForeground fillColor={waveFillColor} />
 ...
 <TouchableOpacity onPress={onPressMyQr}>
